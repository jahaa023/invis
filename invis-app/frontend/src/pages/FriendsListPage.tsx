                ...
                {onlineFriends.length > 0 ? (
                    <>
                        {onlineFriends.map((row: friendListRow) => {
                            return (
                                <div className="w-full p-2 rounded-md hover:bg-bg-header-button flex items-center gap-2 relative">
                                    <img
                                        src={row.profile_picture_url}
                                        className="w-9 h-9 rounded-full border-background-black border-2"
                                    />
                                    <p className="max-w-[70%] overflow-hidden overflow-ellipsis">
                                        {row.username}
                                    </p>
