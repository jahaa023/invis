export default function FriendsListPage() {
    return(
        <div className="w-full h-full flex">
            <div className="sm:w-[60%] w-full h-full max-h-full overflow-x-hidden overflow-y-scroll p-3">
            ...
            <div className="sm:inline hidden w-[40%] h-full max-h-full overflow-x-hidden overflow-y-scroll border-l-2 border-black-lighter-border p-3">
