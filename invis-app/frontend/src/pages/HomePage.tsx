        ...
        <>
            <div className="w-screen- flex items-center flex-col">
                <div className="pt-20 pb-20 flex flex-col md:flex-row justify-center items-center gap-8 w-[calc(100vw-50px)] px-[25px] md:w-[calc(100vw-100px)] md:px-[50px]">
                    <img
                        className="w-43 md:w-60 lg:w-90"
                        src="/images/logo.svg"
                    ...
                    <div className="float-left clear-left">
                        ...
                        <p className="max-w-130 pb-2">
                            <b>Invis</b> is a private messaging service
                            utilizing end to end encryption to make sure your
                            messages stay uncompromised.
                        </p>
                        <button
                ...
                <div className="p-6 mb-15 border-white border-solid border-2 rounded-3xl max-w-[80%] flex flex-col items-center gap-6">
                    <div className="flex items-center gap-3 max-w-[80%]">
                        ...
                        <div>
                            ...
                            <p className="font-light">
                                Your private messages are encrypted before they
                                get sent over the internet, meaning that bad
                                actors cannot read your messages as they are
                                transferred.
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 max-w-[80%]">
                        ...
                        <div>
                            ...
                            <p className="font-light">
                                We are open source and all the code for Invis is
                                publicly available on GitHub. You can visit the
                                GitHub through{" "}
                                <a
                                    href="https://github.com/jahaa023/invis"
                                    target="_blank"
                                >
                                    this link.
                                </a>
                    ...
                    <div className="flex items-center gap-3 max-w-[80%]">
                        ...
                        <div>
                            ...
                            <p className="font-light">
                                Unlike ad-driven platforms, we do not sell your
                                activity or metadata to advertisers as we are a
